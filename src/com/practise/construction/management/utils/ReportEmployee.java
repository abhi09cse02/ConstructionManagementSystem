 ...
 */
public class ReportEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PdfPCell h2 = new PdfPCell(new Paragraph("Employee name"));
			...
			PdfPCell h4 = new PdfPCell(new Paragraph("Date of Birth"));
